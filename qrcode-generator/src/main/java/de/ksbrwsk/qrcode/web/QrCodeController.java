...
public class QrCodeController {
	...
	Logger log = LoggerFactory.getLogger(QrCodeController.class);
	...
	public String processUrl(Model model, @Valid @ModelAttribute("qrCodeUrl") QrCodeUrl qrCodeUrl,
	...
	public String processPhone(Model model, @Valid @ModelAttribute("qrCodePhone") QrCodePhone qrCodePhone,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
	...
	public String processFacetime(Model model, @Valid @ModelAttribute("qrCodeFacetime") QrCodeFacetime qrCodeFacetime,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
	...
	public String processEmail(Model model, @Valid @ModelAttribute("qrCodeEmail") QrCodeEmail qrCodeEmail,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
	...
	public String processSms(Model model, @Valid @ModelAttribute("qrCodeSms") QrCodeSms qrCodeSms,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
	...
	public String processVCard(Model model, @Valid @ModelAttribute("qrCodeVCard") QrCodeVCard qrCodeVCard,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
	...
	public String processEvent(Model model, @Valid @ModelAttribute("qrCodeEvent") QrCodeEvent qrCodeEvent,
			BindingResult bindingResult) {
		addCommonModelAttributes(model);
		if (!bindingResult.hasErrors()) {
